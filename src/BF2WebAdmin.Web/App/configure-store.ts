...
export default function configureStore(initialState?: Store.ApplicationState) {
    ...
    const store = createStoreWithMiddleware(allReducers, initialState) as Redux.Store<any>;
...
function buildRootReducer(allReducers : any) {
    return combineReducers(Object.assign({}, allReducers, { routing: routerReducer })) as Redux.Reducer<any>;
}