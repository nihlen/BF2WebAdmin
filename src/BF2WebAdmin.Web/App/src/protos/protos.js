...
$root.ChatEvent = (function() {
    ...
    ChatEvent.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChatEvent();
    ...
    ChatEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.ChatEvent)
            return object;
        var message = new $root.ChatEvent();
        if (object.Message != null) {
            if (typeof object.Message !== "object")
                throw TypeError(".ChatEvent.Message: object expected");
...
$root.GameStateEvent = (function() {
    ...
    GameStateEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameStateEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    GameStateEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.GameStateEvent)
            return object;
...
$root.IMessage = (function() {
    ...
    IMessage.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.IMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    IMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.IMessage)
            return object;
        var message = new $root.IMessage();
        if (object.Payload != null) {
            if (typeof object.Payload !== "object")
                throw TypeError(".IMessage.Payload: object expected");
...
$root.IMessagePayload = (function() {
    ...
    IMessagePayload.encode = function encode(message, writer) {
        ...
        if (message.PlayerPositionEvent != null && message.hasOwnProperty("PlayerPositionEvent"))
            $root.PlayerPositionEvent.encode(message.PlayerPositionEvent, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        if (message.PlayerVehicleEvent != null && message.hasOwnProperty("PlayerVehicleEvent"))
            $root.PlayerVehicleEvent.encode(message.PlayerVehicleEvent, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
        ...
        if (message.PlayerDeathEvent != null && message.hasOwnProperty("PlayerDeathEvent"))
            $root.PlayerDeathEvent.encode(message.PlayerDeathEvent, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        if (message.PlayerSpawnEvent != null && message.hasOwnProperty("PlayerSpawnEvent"))
            $root.PlayerSpawnEvent.encode(message.PlayerSpawnEvent, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
        ...
        if (message.PlayerScoreEvent != null && message.hasOwnProperty("PlayerScoreEvent"))
            $root.PlayerScoreEvent.encode(message.PlayerScoreEvent, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
        if (message.ProjectilePositionEvent != null && message.hasOwnProperty("ProjectilePositionEvent"))
            $root.ProjectilePositionEvent.encode(message.ProjectilePositionEvent, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
        ...
        if (message.ServerUpdateEvent != null && message.hasOwnProperty("ServerUpdateEvent"))
            $root.ServerUpdateEvent.encode(message.ServerUpdateEvent, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
        ...
        if (message.UserConnectAction != null && message.hasOwnProperty("UserConnectAction"))
            $root.UserConnectAction.encode(message.UserConnectAction, writer.uint32(/* id 101, wireType 2 =*/810).fork()).ldelim();
        if (message.UserDisconnectAction != null && message.hasOwnProperty("UserDisconnectAction"))
            $root.UserDisconnectAction.encode(message.UserDisconnectAction, writer.uint32(/* id 102, wireType 2 =*/818).fork()).ldelim();
        return writer;
    };
    ...
    IMessagePayload.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.IMessagePayload();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    IMessagePayload.fromObject = function fromObject(object) {
        if (object instanceof $root.IMessagePayload)
            return object;
        ...
        if (object.ChatEvent != null) {
            if (typeof object.ChatEvent !== "object")
                throw TypeError(".IMessagePayload.ChatEvent: object expected");
...
$root.MapChangeEvent = (function() {
    ...
    MapChangeEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MapChangeEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    MapChangeEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.MapChangeEvent)
            return object;
...
$root.MessageDto = (function() {
    ...
    MessageDto.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MessageDto();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    MessageDto.fromObject = function fromObject(object) {
        if (object instanceof $root.MessageDto)
            return object;
...
$root.PlayerDeathEvent = (function() {
    ...
    PlayerDeathEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerDeathEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerDeathEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerDeathEvent)
            return object;
        ...
        if (object.Position != null) {
            if (typeof object.Position !== "object")
                throw TypeError(".PlayerDeathEvent.Position: object expected");
...
$root.PlayerDto = (function() {
    ...
    PlayerDto.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerDto();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerDto.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerDto)
            return object;
        ...
        if (object.Score != null) {
            if (typeof object.Score !== "object")
                throw TypeError(".PlayerDto.Score: object expected");
...
$root.PlayerJoinEvent = (function() {
    ...
    PlayerJoinEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerJoinEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerJoinEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerJoinEvent)
            return object;
        var message = new $root.PlayerJoinEvent();
        if (object.Player != null) {
            if (typeof object.Player !== "object")
                throw TypeError(".PlayerJoinEvent.Player: object expected");
...
$root.PlayerKillEvent = (function() {
    ...
    PlayerKillEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerKillEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerKillEvent.verify = function verify(message) {
        ...
        if (message.AttackerPosition != null && message.hasOwnProperty("AttackerPosition")) {
            ...
            if (error)
                return "AttackerPosition." + error;
        }
        if (message.VictimId != null && message.hasOwnProperty("VictimId"))
            if (!$util.isInteger(message.VictimId))
                return "VictimId: integer expected";
        if (message.VictimPosition != null && message.hasOwnProperty("VictimPosition")) {
            var error = $root.Vector3.verify(message.VictimPosition);
            if (error)
                return "VictimPosition." + error;
        }
        if (message.Weapon != null && message.hasOwnProperty("Weapon"))
    ...
    PlayerKillEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerKillEvent)
            return object;
        ...
        if (object.Weapon != null)
            message.Weapon = String(object.Weapon);
        return message;
    };
    ...
    PlayerKillEvent.toObject = function toObject(message, options) {
        ...
        if (message.VictimId != null && message.hasOwnProperty("VictimId"))
            object.VictimId = message.VictimId;
        if (message.VictimPosition != null && message.hasOwnProperty("VictimPosition"))
...
$root.PlayerLeftEvent = (function() {
    ...
    PlayerLeftEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerLeftEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerLeftEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerLeftEvent)
            return object;
...
$root.PlayerPositionEvent = (function() {
    ...
    PlayerPositionEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerPositionEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerPositionEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerPositionEvent)
            return object;
        ...
        if (object.Position != null) {
            if (typeof object.Position !== "object")
                throw TypeError(".PlayerPositionEvent.Position: object expected");
            message.Position = $root.Vector3.fromObject(object.Position);
        }
        if (object.Rotation != null) {
            if (typeof object.Rotation !== "object")
                throw TypeError(".PlayerPositionEvent.Rotation: object expected");
...
$root.PlayerScoreEvent = (function() {
    ...
    PlayerScoreEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerScoreEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerScoreEvent.verify = function verify(message) {
        ...
        if (message.PlayerId != null && message.hasOwnProperty("PlayerId"))
            if (!$util.isInteger(message.PlayerId))
                return "PlayerId: integer expected";
        if (message.TeamScore != null && message.hasOwnProperty("TeamScore"))
            if (!$util.isInteger(message.TeamScore))
                return "TeamScore: integer expected";
        if (message.TotalScore != null && message.hasOwnProperty("TotalScore"))
    ...
    PlayerScoreEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerScoreEvent)
            return object;
        ...
        if (object.PlayerId != null)
            message.PlayerId = object.PlayerId | 0;
        if (object.TeamScore != null)
            message.TeamScore = object.TeamScore | 0;
    ...
    PlayerScoreEvent.toObject = function toObject(message, options) {
        ...
        if (message.PlayerId != null && message.hasOwnProperty("PlayerId"))
            object.PlayerId = message.PlayerId;
        if (message.TeamScore != null && message.hasOwnProperty("TeamScore"))
            object.TeamScore = message.TeamScore;
        if (message.TotalScore != null && message.hasOwnProperty("TotalScore"))
...
$root.PlayerSpawnEvent = (function() {
    ...
    PlayerSpawnEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerSpawnEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerSpawnEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerSpawnEvent)
            return object;
        ...
        if (object.Position != null) {
            if (typeof object.Position !== "object")
                throw TypeError(".PlayerSpawnEvent.Position: object expected");
            message.Position = $root.Vector3.fromObject(object.Position);
        }
        if (object.Rotation != null) {
            if (typeof object.Rotation !== "object")
                throw TypeError(".PlayerSpawnEvent.Rotation: object expected");
            message.Rotation = $root.Vector3.fromObject(object.Rotation);
        }
        return message;
    };
...
$root.PlayerTeamEvent = (function() {
    ...
    PlayerTeamEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerTeamEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerTeamEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerTeamEvent)
            return object;
...
$root.PlayerVehicleEvent = (function() {
    ...
    PlayerVehicleEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerVehicleEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    PlayerVehicleEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerVehicleEvent)
            return object;
        ...
        if (object.Vehicle != null) {
            if (typeof object.Vehicle !== "object")
                throw TypeError(".PlayerVehicleEvent.Vehicle: object expected");
...
$root.ProjectilePositionEvent = (function() {
    ...
    ProjectilePositionEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ProjectilePositionEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    ProjectilePositionEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.ProjectilePositionEvent)
            return object;
        var message = new $root.ProjectilePositionEvent();
        if (object.Position != null) {
            if (typeof object.Position !== "object")
                throw TypeError(".ProjectilePositionEvent.Position: object expected");
            message.Position = $root.Vector3.fromObject(object.Position);
        }
        ...
        if (object.Rotation != null) {
            if (typeof object.Rotation !== "object")
                throw TypeError(".ProjectilePositionEvent.Rotation: object expected");
            message.Rotation = $root.Vector3.fromObject(object.Rotation);
        }
...
$root.ScoreDto = (function() {
    ...
    ScoreDto.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ScoreDto();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    ScoreDto.fromObject = function fromObject(object) {
        if (object instanceof $root.ScoreDto)
            return object;
...
$root.ServerUpdateEvent = (function() {
    ...
    ServerUpdateEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerUpdateEvent();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    ServerUpdateEvent.verify = function verify(message) {
        ...
        if (message.QueryPort != null && message.hasOwnProperty("QueryPort"))
            if (!$util.isInteger(message.QueryPort))
                return "QueryPort: integer expected";
        return null;
    };
    ...
    ServerUpdateEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.ServerUpdateEvent)
            return object;
    ...
    ServerUpdateEvent.toObject = function toObject(message, options) {
        ...
        if (message.QueryPort != null && message.hasOwnProperty("QueryPort"))
            object.QueryPort = message.QueryPort;
        return object;
    };
...
$root.UserConnectAction = (function() {
    ...
    UserConnectAction.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.UserConnectAction();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    UserConnectAction.fromObject = function fromObject(object) {
        if (object instanceof $root.UserConnectAction)
            return object;
...
$root.UserDisconnectAction = (function() {
    ...
    UserDisconnectAction.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.UserDisconnectAction();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    UserDisconnectAction.fromObject = function fromObject(object) {
        if (object instanceof $root.UserDisconnectAction)
            return object;
...
$root.VehicleDto = (function() {
    ...
    VehicleDto.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.VehicleDto();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    VehicleDto.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.RootVehicleId != null && message.hasOwnProperty("RootVehicleId"))
            if (!$util.isInteger(message.RootVehicleId))
                return "RootVehicleId: integer expected";
        if (message.RootVehicleTemplate != null && message.hasOwnProperty("RootVehicleTemplate"))
            if (!$util.isString(message.RootVehicleTemplate))
                return "RootVehicleTemplate: string expected";
        return null;
    };
    ...
    VehicleDto.fromObject = function fromObject(object) {
        if (object instanceof $root.VehicleDto)
            return object;
        var message = new $root.VehicleDto();
        if (object.RootVehicleId != null)
            message.RootVehicleId = object.RootVehicleId | 0;
        if (object.RootVehicleTemplate != null)
            message.RootVehicleTemplate = String(object.RootVehicleTemplate);
        return message;
    };
